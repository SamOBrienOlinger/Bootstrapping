...
A set of Bootstrap learning pages exploring responsive grids and a Whiskey Drop landing-page example.
...
- Compare the grid.html and grid-example.html pages.
- Explore a responsive marketing-page layout.
...
```bash
git clone https://github.com/SamOBrienOlinger/Bootstrapping.git
cd Bootstrapping
...
Repository maintained in [Sam O’Brien-Olinger’s GitHub account](https://github.com/SamOBrienOlinger). For a problem or suggested improvement, [open an issue](https://github.com/SamOBrienOlinger/Bootstrapping/issues) with the affected page or command, steps to reproduce, and expected behaviour.

[Back to top](#bootstrap--layout-practice)
